...
"""
    ...
    #plt.scatter(x_means.cluster_centers_[:,0], x_means.cluster_centers_[:,1], x_means.cluster_centers_[:2], c = "r", marker = "+", s = 100)
    #plt.xlim(0, 3)
    #plt.ylim(0, 3)
    #plt.zlim(0, 3)
    ...
    ax.scatter(x, y, z, c = x_means.labels_, s = 30)
    #ax.scatter(x_means.cluster_centers_[:,0], x_means.cluster_centers_[:,1], x_means.cluster_centers_[:2], c = "r", marker = "+", s = 100)
